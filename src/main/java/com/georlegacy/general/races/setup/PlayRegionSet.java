...
public class PlayRegionSet {
    ...
    public void execute(Player player, String[] args) {
        ...
        if (args.length == 2) {
            player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSorry! &7You need to provide the position you wish to set for the play region. Use &4/races help setup &7to see help on this command."));
            return;
        }
        if (args.length == 3||args.length == 4) {
            ...
            if (args.length == 3) {
                ...
                if (args[2].equals("1")) {
                    if (map.setPlayRegionP1(player.getLocation().toVector())) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 1st position for the play region has been set to &4" + loc + "&7."));
                    }
                    else {
                ...
                if (args[2].equals("2")) {
                    if (map.setPlayRegionP2(player.getLocation().toVector())) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 2nd position for the play region has been set to &4" + loc + "&7."));
                    }
                    else {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lWarning! &7This position was already set the position you set it to previously."));
                    }
            ...
            if (args.length == 4) {
                ...
                if (args[2].equals("1")) {
                    map.setPlayRegionP1(new Vector(Integer.parseInt(coords[0]), Integer.parseInt(coords[1]), Integer.parseInt(coords[2])));
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 1st position for the play region has been set to &4" + coords[0] + ", " + coords[1] + ", " + coords[2] + "&7."));
                    if (map.isSetup()) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lWarning! &7This map has already finalised setup and will need to be finalised again. It will not be playable until this is done."));
                    }
                    return;
                ...
                if (args[2].equals("2")) {
                    map.setPlayRegionP2(new Vector(Integer.parseInt(coords[0]), Integer.parseInt(coords[1]), Integer.parseInt(coords[2])));
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 2nd position for the play region has been set to &4" + coords[0] + ", " + coords[1] + ", " + coords[2] + "&7."));
                    if (map.isSetup()) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lWarning! &7This map has already finalised setup and will need to be finalised again. It will not be playable until this is done."));
                    }
                    return;
