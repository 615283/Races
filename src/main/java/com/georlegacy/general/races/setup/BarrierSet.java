        ...
        if (args.length == 3||args.length == 4) {
            ...
            if (args.length == 4) {
                ...
                if (args[2].equals("1")) {
                    ...
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 1st position for the barrier has been set to &4" + coords[0] + ", " + coords[1] + ", " + coords[2] + "&7."));
                    if (map.isSetup()) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lWarning! &7This map has already finalised setup and will need to be finalised again. It will not be playable until this is done."));
                    }
                    return;
                ...
                if (args[2].equals("2")) {
                    ...
                    player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lSuccess! &7The 2nd position for the barrier has been set to &4" + coords[0] + ", " + coords[1] + ", " + coords[2] + "&7."));
                    if (map.isSetup()) {
                        player.sendMessage(ChatColor.translateAlternateColorCodes('&', "&c&lWarning! &7This map has already finalised setup and will need to be finalised again. It will not be playable until this is done."));
                    }
                    return;
